    ...
    var component = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        !isVisible && (react_1.default.createElement("noscript", null,
            react_1.default.createElement("img", __assign({}, rest, generateImgAttrs({
                ...
                sizes: sizes,
                loader: loader,
            }), { src: src, decoding: "async", sizes: sizes, style: imgStyle || style, className: className })))),
        react_1.default.createElement("img", __assign({}, rest, imgAttributes, { decoding: "async", className: className, ref: setRef, style: imgStyle || style })),
        priority ? (
